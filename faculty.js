...

{
  ...
  badge: { text: "Science", colorClass: "bg-green-600", iconClass: "fa-solid fa-flask" },
  degrees: "M.Sc (Phy), B.Ed., Dip. in I.S.M",
  bio: "Guiding young minds to question, experiment, and innovate.",
  socials: { linkedin: "#", facebook: "#" }
},
...

{
  ...
  degrees: "M.Com, B.Ed",
  bio: "Turning calculations into decisions, and knowledge into success.",
  socials: { 
    instagram: "#", 
    facebook: "#" 
  }
...

{
  ...
  function createFacultyCard(t) {
    ...
    img.alt = t.name;
    img.className = "w-full h-64 object-cover transform transition-transform duration-700 group-hover:scale-110";
